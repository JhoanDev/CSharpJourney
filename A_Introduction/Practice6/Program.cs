...
//a taxa que incide é de 8% apenas sobre R$ 1000.00, pois a faixa de
...
namespace MyApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double imposto = 0;
            if (salario > 2000 && salario <= 3000) imposto = (salario - 2000) * 0.08;
            else if (salario > 3000 && salario <= 4500) imposto = (1000 * 0.08) + (salario - 3000) * 0.18;
            else if (salario > 4500) imposto = imposto = (1000 * 0.08) + (1500 * 0.18) + (salario - 4500) * 0.28;

            if (imposto == 0) Console.WriteLine("Isento");
            else Console.WriteLine("R$ " + imposto.ToString("F2"));
        }
    }
}